...
module.exports = class SlideUX
  ...
  addComponent : (componentData) ->
    switch componentData.kind
      ...
      when "episode-intro"       then component = new EpisodeIntro @$el, componentData.config
      when "episode-outro"       then component = new EpisodeOutro @$el, componentData.config
      ...
      when "gut-check"           then component = new GutCheck @$el, componentData.config
