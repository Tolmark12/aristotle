  ...
  AssetPreloader.prototype.lookForFiles = function(item, storage, regex) {
    ...
    if (type === "string") {
      if (/.mp3|.m4a|.json/.test(item)) {
        return storage.push({
          src: (aristotle.getAssetPath(item)) + "?v=" + this.stamp,
          id: item
        });
      }
    } else if (type === "object") {
