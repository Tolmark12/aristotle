...
module.exports = VCRControls = (function() {
  ...
  VCRControls.prototype.activate = function(svgAnimation, completeCb) {
    ...
    this.enterFrame = this.animation.addEventListener('enterFrame', (function(_this) {
      return function() {
        var perc;
    ...
    return this.complete = this.animation.addEventListener('complete', (function(_this) {
      return function() {
        _this.animation.removeEventListener('enterFrame', _this.enterFrame);
        _this.animation.removeEventListener('complete', _this.complete);
...
module.exports = AudioTrack = (function() {
  ...
  AudioTrack.prototype.addOnComplete = function() {
    return this.completeListener = this.sound.addEventListener("complete", (function(_this) {
      return function() {
        _this.sound.removeEventListener("complete", _this.completeListener);
  ...
  AudioTrack.prototype.destroy = function() {
    ...
    if (this.completeListener != null) {
      this.sound.removeEventListener("complete", this.completeListener);
    }
...
module.exports = SVGAnimation = (function() {
  function SVGAnimation(el, json, data) {
    ...
    this.dateReadyListner = this.animation.addEventListener('data_ready', (function(_this) {
      return function() {
        _this.animation.removeEventListener('data_ready', _this.datadateReadyListner);
