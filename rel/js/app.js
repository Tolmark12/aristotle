...
module.exports = Duties = (function(superClass) {
  ...
  Duties.prototype.getUserHtml = function(data) {
    ...
    xobj = new XMLHttpRequest();
    xobj.open('GET', path, true);
    xobj.upload.addEventListener("progress", (function(_this) {
      return function(e) {
        console.log(":: progress ::");
        return console.log(e);
      };
    })(this));
    xobj.upload.addEventListener("load", (function(_this) {
      return function(e) {
        console.log(":: load ::");
        return console.log(e);
      };
    })(this));
    xobj.upload.addEventListener("error", (function(_this) {
      return function(e) {
        console.log(":: error ::");
        return console.log(e);
      };
    })(this));
    xobj.upload.addEventListener("abort", (function(_this) {
      return function(e) {
        console.log(":: abort ::");
        return console.log(e);
      };
