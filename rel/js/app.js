  ...
  TextDialogue.prototype.say = function(text, audio, next, txtPos) {
    ...
    if (audio != null) {
      ...
      if ((aristotle.deadFiles[audio] != null) || !aristotle.sound) {
        ...
        if (next === "audio") {
          this.timeout = aristotle.timeout((function(_this) {
            return function() {
