...
module.exports = LMSProxy = (function() {
  ...
  LMSProxy.prototype.begin = function(cb) {
    ...
    if (elbScorm.initCourse()) {
      ...
      if (stateData != null) {
        if (stateData.version.storeVersion < aristotle.version.storeVersion || (stateData.version.storeVersion == null)) {
          console.log("if");
