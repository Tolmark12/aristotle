...
module.exports = AudioTrack = (function() {
  ...
  function AudioTrack(src) {
    ...
    try {
      ...
      handle = this.sound.addEventListener("failed", function() {
        return log("AudioTrack - Sound Failed!");
      });
      this.trackEventHandler('complete', handle);
    } catch (error1) {
      error = error1;
