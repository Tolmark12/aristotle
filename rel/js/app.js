...
module.exports = Top = (function() {
  function Top($el1) {
    ...
    token6 = PubSub.subscribe("chrome.hideLocation", (function(_this) {
      return function(m, data) {
        return _this.hideLocation();
      };
    })(this));
    token6 = PubSub.subscribe("chrome.showLocation", (function(_this) {
      return function(m, data) {
        return _this.showLocation();
      };
    })(this));
  ...
  Top.prototype.hideLocation = function() {
    return this.$mode.addClass("hidden");
  };

  Top.prototype.showLocation = function() {
...
module.exports = DevTools = (function() {
  ...
  DevTools.prototype.go = function(devConfig, items) {
    ...
    this.removeSkippedSlides(devConfig, items);
  ...
  DevTools.prototype.removeSkippedSlides = function(devConfig, items) {
...
module.exports = LocalStorageProxy = (function() {
  ...
  LocalStorageProxy.prototype.setAristotleVars = function() {
    console.log("LOADING : " + this.store.initParams.configFile);
...
module.exports = Quiz = (function(superClass) {
  ...
  function Quiz($el1, data1) {
    ...
    PubSub.publish("chrome.hideLocation");
